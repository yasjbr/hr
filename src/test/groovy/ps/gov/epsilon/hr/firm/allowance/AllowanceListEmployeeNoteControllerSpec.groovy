...
/**
 * unit test for AllowanceListEmployeeNote controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([AllowanceListEmployeeNote])
@Build([AllowanceListEmployeeNote])
@TestFor(AllowanceListEmployeeNoteController)
class AllowanceListEmployeeNoteControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_success_save"() {
        ...
        params["note"] = "allowanceListEmployeeNote"
        params["orderNo"] = 124
        request.method = 'POST'
