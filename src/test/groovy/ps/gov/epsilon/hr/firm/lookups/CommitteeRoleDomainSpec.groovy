...
@Build([CommitteeRole,ps.gov.epsilon.hr.firm.Firm])
@Domain([CommitteeRole])
@TestMixin([HibernateTestMixin])
class CommitteeRoleDomainSpec extends ConstraintUnitSpec {

    void "test CommitteeRole all constraints"() {
        when:
        ...
        then:
        validateObject(CommitteeRole,constraints)
    }
}
