...
/**
 * unit test for MilitaryRank controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([MilitaryRank])
@Build([MilitaryRank, Firm])
@TestFor(MilitaryRankController)
class MilitaryRankControllerSpec extends CommonUnitSpec {
    def setupSpec() {
        domain_class = MilitaryRank
        service_domain = MilitaryRankService
        entity_name = "militaryRank"
        required_properties = PCPUtils.getRequiredFields(MilitaryRank)
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = MilitaryRank.build(firm: firm)
