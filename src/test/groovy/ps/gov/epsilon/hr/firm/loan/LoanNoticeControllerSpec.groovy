...
/**
 * unit test for LoanNotice controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([LoanNotice])
@Build([LoanNotice,JoinedFirmOperationDocument, Firm])
@TestFor(LoanNoticeController)
class LoanNoticeControllerSpec extends CommonUnitSpec {
    ...
    def "test_list"() {
        ...
        model.operationType == EnumOperation.LOAN_NOTICE
        model.referenceObject == LoanNotice.name
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = LoanNotice.build(firm: firm)
