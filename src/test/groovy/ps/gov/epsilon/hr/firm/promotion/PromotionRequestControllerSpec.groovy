...
/**
 * unit test for PromotionRequest controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([PromotionRequest])
@Build([PromotionRequest, Employee, JoinedFirmOperationDocument, EmploymentRecord, EmployeePromotion])
@TestFor(PromotionRequestController)
class PromotionRequestControllerSpec extends CommonUnitSpec {
    ...
    def setupSpec() {
        domain_class = PromotionRequest
        service_domain = PromotionRequestService
        entity_name = "promotionRequest"
        required_properties = PCPUtils.getRequiredFields(PromotionRequest)
    ...
    def "test_createNewRequest"() {
        ...
        PromotionRequest request = PromotionRequest.build()
        ...
        model != [:]
        println(model)
        model.promotionRequest.employee.id == request?.employee?.id
    ...
    def "test_createNewRequest_not_found"() {
        ...
        println("test createNewRequest_not_found done with response: ${response.status}")
    }
    ...
    def "test_list"() {
        ...
        model.operationType == EnumOperation.SITUATION_SETTLEMENT
        model.referenceObject == PromotionRequest.name
