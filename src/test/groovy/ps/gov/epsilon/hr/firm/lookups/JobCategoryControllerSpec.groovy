...
/**
 * unit test for JobCategory controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([JobCategory])
@Build([JobCategory, Firm])
@TestFor(JobCategoryController)
class JobCategoryControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = JobCategory.build(firm: firm)
