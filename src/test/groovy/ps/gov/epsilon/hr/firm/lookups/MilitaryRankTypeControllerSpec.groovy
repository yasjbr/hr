...
/**
 * unit test for MilitaryRankType controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([MilitaryRankType])
@Build([MilitaryRankType, Firm])
@TestFor(MilitaryRankTypeController)
class MilitaryRankTypeControllerSpec extends CommonUnitSpec {
    def setupSpec() {
        domain_class = MilitaryRankType
        service_domain = MilitaryRankTypeService
        entity_name = "militaryRankType"
        required_properties = PCPUtils.getRequiredFields(MilitaryRankType)
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = MilitaryRankType.build(firm: firm)
