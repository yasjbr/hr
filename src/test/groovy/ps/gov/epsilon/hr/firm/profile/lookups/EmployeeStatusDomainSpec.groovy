...
@Build([EmployeeStatus, ps.gov.epsilon.hr.firm.profile.lookups.EmployeeStatusCategory, ps.gov.epsilon.hr.firm.Firm])
@Domain([EmployeeStatus])
@TestMixin([HibernateTestMixin])
class EmployeeStatusDomainSpec extends ConstraintUnitSpec {

    void "test EmployeeStatus all constraints"() {
        when:
        List<Map> constraints = [
                ...
                [field: "employeeStatusCategory", value: null, testResult: TestResult.FAIL],
                [field: "employeeStatusCategory", value: " ", testResult: TestResult.FAIL],
                [field: "employeeStatusCategory", value: ps.gov.epsilon.hr.firm.profile.lookups.EmployeeStatusCategory.build(), testResult: TestResult.PASS],
                [field: "firm", value: null, testResult: TestResult.FAIL],
                [field: "firm", value: " ", testResult: TestResult.FAIL],
        ...
        then:
        validateObject(EmployeeStatus, constraints)
    }
}
