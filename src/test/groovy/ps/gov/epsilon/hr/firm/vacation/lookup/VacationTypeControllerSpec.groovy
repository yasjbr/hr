...
/**
 * unit test for VacationType controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([VacationType])
@Build([VacationType, Firm])
@TestFor(VacationTypeController)
class VacationTypeControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = VacationType.build(firm: firm)
