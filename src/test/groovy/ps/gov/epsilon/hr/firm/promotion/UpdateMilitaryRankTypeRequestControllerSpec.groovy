...
/**
 * unit test for UpdateMilitaryRankRequest controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([UpdateMilitaryRankRequest])
@Build([UpdateMilitaryRankRequest, Employee, JoinedFirmOperationDocument, EmploymentRecord, EmployeePromotion])
@TestFor(UpdateMilitaryRankRequestController)
class UpdateMilitaryRankRequestControllerSpec extends CommonUnitSpec {
    ...
    def setupSpec() {
        domain_class = UpdateMilitaryRankRequest
        service_domain = UpdateMilitaryRankRequestService
        entity_name = "updateMilitaryRankRequest"
        required_properties = PCPUtils.getRequiredFields(UpdateMilitaryRankRequest)
    ...
    def "test_createNewRequest"() {
        ...
        model != [:]
        println(model)
        model.updateMilitaryRankRequest.employee.id == request?.employee?.id
    ...
    def "test_createNewRequest_not_found"() {
        setup:
        println("************************test_createNewRequest_not_found********************************")
        when:
    ...
    def "test_list"() {
        ...
        model.operationType == EnumOperation.UPDATE_MILITARY_RANK_TYPE
        model.referenceObject == UpdateMilitaryRankRequest.name
