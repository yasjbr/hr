...
@Build([AllowanceStopReason,ps.gov.epsilon.hr.firm.Firm])
@Domain([AllowanceStopReason])
@TestMixin([HibernateTestMixin])
class AllowanceStopReasonDomainSpec extends ConstraintUnitSpec {

    void "test AllowanceStopReason all constraints"() {
        when:
        ...
        then:
        validateObject(AllowanceStopReason,constraints)
    }
}
