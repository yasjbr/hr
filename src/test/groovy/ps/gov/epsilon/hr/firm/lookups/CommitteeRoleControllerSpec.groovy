...
/**
 * unit test for CommitteeRole controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([CommitteeRole])
@Build([CommitteeRole, Firm])
@TestFor(CommitteeRoleController)
class CommitteeRoleControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = CommitteeRole.build(firm: firm)
