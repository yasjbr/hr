...
/**
 * unit test for Inspection controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([Inspection])
@Build([Inspection, Firm])
@TestFor(InspectionController)
class InspectionControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = Inspection.build(firm: firm)
