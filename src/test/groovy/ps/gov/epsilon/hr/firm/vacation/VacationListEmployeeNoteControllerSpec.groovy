...
/**
 * unit test for VacationListEmployeeNote controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([VacationListEmployeeNote])
@Build([VacationListEmployeeNote])
@TestFor(VacationListEmployeeNoteController)
class VacationListEmployeeNoteControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_success_save"() {
        ...
        params["note"] = "vacationListEmployeeNote"
        params["orderNo"] = 124
        request.method = 'POST'
