...
@Build([MilitaryRankClassification,ps.gov.epsilon.hr.firm.Firm])
@Domain([MilitaryRankClassification])
@TestMixin([HibernateTestMixin])
class MilitaryRankClassificationDomainSpec extends ConstraintUnitSpec {

    void "test MilitaryRankClassification all constraints"() {
        when:
        ...
        then:
        validateObject(MilitaryRankClassification,constraints)
    }
}
