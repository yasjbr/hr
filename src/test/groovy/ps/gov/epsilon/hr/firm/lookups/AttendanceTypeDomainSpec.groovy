...
@Build([AttendanceType,ps.gov.epsilon.hr.firm.Firm])
@Domain([AttendanceType])
@TestMixin([HibernateTestMixin])
class AttendanceTypeDomainSpec extends ConstraintUnitSpec {

    void "test AttendanceType all constraints"() {
        when:
        ...
        then:
        validateObject(AttendanceType,constraints)
    }
}
