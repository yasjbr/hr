...
/**
 * unit test for AllowanceStopReason controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([AllowanceStopReason])
@Build([AllowanceStopReason])
@TestFor(AllowanceStopReasonController)
class AllowanceStopReasonControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = AllowanceStopReason.build(firm: firm)
