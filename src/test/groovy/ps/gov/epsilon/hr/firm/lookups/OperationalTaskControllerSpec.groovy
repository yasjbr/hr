...
/**
 * unit test for OperationalTask controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([OperationalTask])
@Build([OperationalTask, Firm])
@TestFor(OperationalTaskController)
class OperationalTaskControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = OperationalTask.build(firm: firm)
