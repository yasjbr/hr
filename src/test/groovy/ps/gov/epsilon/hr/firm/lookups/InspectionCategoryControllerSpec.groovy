...
/**
 * unit test for InspectionCategory controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([InspectionCategory])
@Build([InspectionCategory, Firm])
@TestFor(InspectionCategoryController)
class InspectionCategoryControllerSpec extends CommonUnitSpec {
    def setupSpec() {
        domain_class = InspectionCategory
        service_domain = InspectionCategoryService
        entity_name = "inspectionCategory"
        required_properties = PCPUtils.getRequiredFields(InspectionCategory)
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = InspectionCategory.build(firm: firm)
