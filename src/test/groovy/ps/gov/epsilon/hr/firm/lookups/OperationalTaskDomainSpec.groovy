...
@Build([OperationalTask,ps.gov.epsilon.hr.firm.Firm])
@Domain([OperationalTask])
@TestMixin([HibernateTestMixin])
class OperationalTaskDomainSpec extends ConstraintUnitSpec {

    void "test OperationalTask all constraints"() {
        when:
        ...
        then:
        validateObject(OperationalTask,constraints)
    }
}
