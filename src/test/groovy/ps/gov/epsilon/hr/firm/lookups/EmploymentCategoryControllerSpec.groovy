...
/**
 * unit test for EmploymentCategory controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([EmploymentCategory])
@Build([EmploymentCategory, Firm])
@TestFor(EmploymentCategoryController)
class EmploymentCategoryControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = EmploymentCategory.build(firm: firm)
