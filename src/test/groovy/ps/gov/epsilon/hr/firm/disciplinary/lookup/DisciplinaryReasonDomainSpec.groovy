...
@Build([DisciplinaryReason,ps.gov.epsilon.hr.firm.disciplinary.lookup.DisciplinaryCategory,ps.gov.epsilon.hr.firm.Firm])
@Domain([DisciplinaryReason])
@TestMixin([HibernateTestMixin])
class DisciplinaryReasonDomainSpec extends ConstraintUnitSpec {

    void "test DisciplinaryReason all constraints"() {
        when:
        List<Map> constraints = [
                [field: "descriptionInfo", value: null, testResult: TestResult.FAIL],
                [field: "disciplinaryCategories", value: null, testResult: TestResult.FAIL],
                [field: "disciplinaryCategories", value: ps.gov.epsilon.hr.firm.disciplinary.lookup.DisciplinaryCategory.build(), testResult: TestResult.PASS],
        ...
        then:
        validateObject(DisciplinaryReason,constraints)
    }
}
