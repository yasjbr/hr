...
/**
 * unit test for AttendanceType controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Domain([AttendanceType])
@Build([AttendanceType, Firm])
@TestFor(AttendanceTypeController)
class AttendanceTypeControllerSpec extends CommonUnitSpec {

    def setupSpec() {
        domain_class = AttendanceType
        service_domain = AttendanceTypeService
        entity_name = "attendanceType"
        required_properties = PCPUtils.getRequiredFields(AttendanceType)
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = AttendanceType.build(firm: firm)
