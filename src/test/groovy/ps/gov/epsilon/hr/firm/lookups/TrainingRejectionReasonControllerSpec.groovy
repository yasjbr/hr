...
/**
 * unit test for TrainingRejectionReason controller
 */
@TestMixin([HibernateTestMixin, GroovyPageUnitTestMixin, ServiceUnitTestMixin])
@Mock([AlertTagLib])
@Domain([TrainingRejectionReason])
@Build([TrainingRejectionReason, Firm])
@TestFor(TrainingRejectionReasonController)
class TrainingRejectionReasonControllerSpec extends CommonUnitSpec {
    def setupSpec() {
    ...
    def "test_override_success_virtual_delete"() {
        ...
        def testInstance = TrainingRejectionReason.build(firm: firm)
