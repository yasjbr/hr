...
@Build([InspectionCategory,ps.gov.epsilon.hr.firm.Firm])
@Domain([InspectionCategory])
@TestMixin([HibernateTestMixin])
class InspectionCategoryDomainSpec extends ConstraintUnitSpec {

    void "test InspectionCategory all constraints"() {
        when:
        List<Map> constraints = [
                ...
                [field: "inspections", value: null, testResult: TestResult.PASS],
                [field: "isRequiredByFirmPolicy", value: null, testResult: TestResult.FAIL],
        ...
        then:
        validateObject(InspectionCategory,constraints)
    }
}
