            ...
            <lay:widget transparent="true" color="green3" icon="fa fa-certificate"
                ...
                <lay:widgetBody>
                    <g:render template="/request/wrapperManagerialOrder"
                              model="[request: disciplinaryRequest, formName: 'disciplinaryRequestForm']"/>
                </lay:widgetBody>
            </lay:widget>
        </g:if>
