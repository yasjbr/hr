<el:validatableModalForm title="${message(code: 'list.sendList.label')}"
    ...
    <el:hiddenField name="encodedId" id="encodedId" value="${dispatchList?.encodedId}"></el:hiddenField>
    <msg:modal/>
    ...
    <el:formGroup>
        <el:dateField name="fromDate"
                      size="8"
                      class=" isRequired"
                      label="${message(code: 'dispatchList.fromDate.label')}"
    ...
    <el:formGroup>
        <el:textField name="manualOutgoingNo"
                      size="8"
                      class="isRequired"
                      label="${message(code: 'dispatchList.manualOutgoingNo.label', default: 'manualOutgoingNo')}"
                      value=""/>
    </el:formGroup>
