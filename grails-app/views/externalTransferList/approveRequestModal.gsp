<el:validatableModalForm title="${message(code: 'externalTransferList.acceptExternalTransferList.label')}"
                         name="receiveListForm" callBackFunction="callBackFunction"
                         controller="externalTransferList" action="changeRequestToApproved">
