...
<head>
    ...
    <g:set var="entity"
           value="${message(code: 'vacationRequest.listVacationRequest.label', default: 'vacationRequest List')}"/>
    <g:set var="title"
    ...
    <lay:widgetBody>
        <el:row>
            ...
            <el:validatableResetForm name="vacationRequestForm" callLoadingFunction="performPostActionWithEncodedId"
                                     controller="vacationRequest" action="saveAll">
                <g:render template="/vacationRequest/listForm"
