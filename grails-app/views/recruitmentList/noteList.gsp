...
<g:set var="dataTableTitle" value="${message(code: 'default.list.label', args: [entities], default: 'recruitmentListEmployeeNote List')}"/>
        ...
        <lay:widgetToolBar>
            <btn:buttonGroup>
                <el:modalLink preventCloseOutSide="true" class="btn btn-sm btn-info2 width-135"
                              link="${createLink(controller: 'recruitmentList', action: 'noteCreate', id: applicantId)}"
        ...
        <lay:widgetBody>
            <el:form action="#" name="recruitmentListEmployeeNoteSearchForm">
                ...
                <el:formButton functionName="clear"
                               onClick="gui.formValidatable.resetForm('recruitmentListEmployeeNoteSearchForm');_dataTables['employeeNoteTable'].draw();"/>
            </el:form>
        </lay:widgetBody>
    </lay:collapseWidget>

    <el:dataTable id="employeeNoteTable"
                  searchFormName="recruitmentListEmployeeNoteSearchForm"
                  ...
                  hasRow="true"
                  action="filter"
                  serviceName="recruitmentListEmployeeNote">
        <el:dataTableAction controller="recruitmentListEmployeeNote" action="delete" actionParams="encodedId"
                            class="red icon-trash" type="confirm-delete"
                            message="${message(code: 'default.delete.label', args: [entity], default: 'delete recruitmentListEmployeeNote')}"/>
    </el:dataTable>
</el:modal>
