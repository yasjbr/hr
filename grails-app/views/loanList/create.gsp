...
<head>
    ...
    <g:set var="entity" value="${message(code: 'loanList.entity', default: 'Loan List')}" />
...
<lay:widget title="${title}">
    ...
    <lay:widgetBody>
        <el:row>
            <msg:page />
            <el:validatableResetForm name="loanListForm" callLoadingFunction="performPostActionWithEncodedId" controller="loanList" action="save">
