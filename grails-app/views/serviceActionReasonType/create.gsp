...
<head>
    ...
    <g:set var="title" value="${message(code: 'default.create.label',args:[entity], default: 'ServiceActionReasonType List')}" />
    <title>${title}</title>
</head>
<body>
<lay:widget title="${title}">
    ...
    <lay:widgetBody>
        <el:row>
            <msg:page />
            <el:validatableResetForm name="serviceActionReasonTypeForm" callLoadingFunction="performPostActionWithEncodedId" controller="serviceActionReasonType" action="save">
                <g:render template="/serviceActionReasonType/form" model="[serviceActionReasonType:serviceActionReasonType]"/>
