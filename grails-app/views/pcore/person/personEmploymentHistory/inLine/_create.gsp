...
<el:validatableResetForm callBackFunction="callBackPersonEmploymentHistory"
                         name="personEmploymentHistoryForm" controller="personEmploymentHistory" action="save">
    <g:render template="/pcore/person/personEmploymentHistory/form"
              model="[
