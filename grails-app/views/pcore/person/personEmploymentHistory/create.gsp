...
<head>
    ...
    <g:set var="title" value="${message(code: 'default.create.label',args:[entity], default: 'PersonEmploymentHistory List')}" />
    <title>${title}</title>
</head>
<body>
<lay:widget title="${title}">
    ...
    <lay:widgetBody>
        <el:row>
            <msg:page />
            <el:validatableResetForm name="personEmploymentHistoryForm" controller="personEmploymentHistory" action="save">
