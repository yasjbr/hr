<el:validatableModalForm title="${message(code: 'vacationList.sendVacationList.label')}"
                         width="60%"
                         name="sendListForm" callBackFunction="callBackFunction"
                         controller="vacationList" action="sendData">
    <msg:modal/>
    ...
    <el:formGroup>
        <el:dateField name="fromDate"
                      size="8"
                      class=" isRequired"
                      label="${message(code: 'vacationList.currentStatus.fromDate.label')}"
