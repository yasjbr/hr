...
<head>
    ...
    <g:set var="entity" value="${message(code: 'EnumCorrespondenceDirection.OUTGOING', default: 'Outgoing')}" />
    <g:set var="title" value="${message(code: 'default.create.label',args:[entity], default: 'Create Outgoing')}" />
    <title>${title}</title>
