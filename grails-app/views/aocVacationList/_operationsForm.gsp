<form id="requestSearchForm">
    ...
    <el:hiddenField id="vacationTypeId" name="vacationType.id" value="${vacationTypeId}"/>
    <el:hiddenField id="firmId" name="firm.id" value="${firmId}"/>
</form>
<g:set var="title" value="${message(code: 'default.list.label', args: [message(code:'vacationRequest.label')], default: 'VacationRequest List')}"/>
<el:dataTable id="requestsTable" searchFormName="requestSearchForm"
              ...
              action="filterCanHaveOperation" serviceName="vacationRequest">
</el:dataTable>
