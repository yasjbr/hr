...
<head>
    ...
    <script>
        function successCallBack(json) {
            if (json.success) {
                window.location.href = "${createLink(controller: 'externalTransferRequest',action: 'createNewExternalTransferRequest')}?employeeId=" + json.employeeId;
            }
        }
    </script>
</head>
...
<lay:widget title="${title}">
    ...
    <lay:widgetBody>
        <el:row>
            ...
            <el:validatableResetForm name="externalTransferRequestForm" callBackFunction="successCallBack"
                                     controller="externalTransferRequest" action="selectEmployee">
