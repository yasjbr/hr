...
<head>
    ...
    <g:set var="title" value="${message(code: 'default.edit.label',args:[entity], default: 'AttendanceType List')}" />
    <title>${title}</title>
...
<lay:widget title="${title}">
    ...
    <lay:widgetBody>
        <el:row>
            <msg:page />
            <el:validatableForm name="attendanceTypeForm" controller="attendanceType" action="update">
                <el:hiddenField name="id" value="${attendanceType?.id}" />
