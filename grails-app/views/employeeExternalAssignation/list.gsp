...
<head>
    ...
    <g:set var="entities" value="${message(code: 'employeeExternalAssignation.entities', default: 'EmployeeInternalAssignation List')}" />
    <g:set var="entity" value="${message(code: 'employeeExternalAssignation.entity', default: 'EmployeeInternalAssignation')}" />
...
<lay:collapseWidget id="employeeInternalAssignationCollapseWidget" icon="icon-search"
    ...
    <lay:widgetToolBar>
        <btn:buttonGroup>
            <btn:createButton onClick="window.location.href='${createLink(controller:'employeeExternalAssignation',action:'create')}'"/>
        </btn:buttonGroup>
    </lay:widgetToolBar>
    <lay:widgetBody>
        <el:form action="#" name="employeeInternalAssignationSearchForm">
            <g:render template="/employeeExternalAssignation/search" model="[:]"/>
...
<g:render template="/employeeExternalAssignation/dataTable" model="[title:title]"/>
</body>
</html>