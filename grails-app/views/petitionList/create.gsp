...
<head>
    ...
    <g:set var="title" value="${message(code: 'default.create.label',args:[entity], default: 'PetitionList List')}" />
    <title>${title}</title>
</head>
<body>
<lay:widget title="${title}">
    ...
    <lay:widgetBody>
        <el:row>
            <msg:page />
            <el:validatableResetForm name="petitionListForm" callLoadingFunction="performPostActionWithEncodedId" controller="petitionList" action="save">
