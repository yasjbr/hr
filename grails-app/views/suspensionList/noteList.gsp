...
<el:modal isModalWithDiv="true" title="${dataTableTitle}" width="90%">
        ...
        <lay:widgetToolBar>
            <btn:buttonGroup>
                <el:modalLink preventCloseOutSide="true" class="btn btn-sm btn-info2 width-135"
                              link="${createLink(controller: 'suspensionList', action: 'noteCreate', id: id)}"
    ...
    <el:dataTable id="employeeNoteTable"
        ...
        <el:dataTableAction controller="suspensionListEmployeeNote" action="delete" actionParams="encodedId"
                            ...
                            message="${message(code: 'default.delete.label', args: ' ', default: 'delete suspensionListEmployeeNote')}"/>
    </el:dataTable>
</el:modal>
