...
<head>
    ...
    <g:set var="title" value="${message(code: 'default.create.label',args:[entity], default: 'AllowanceType List')}" />
    <title>${title}</title>
</head>
<body>
<lay:widget title="${title}">
    ...
    <lay:widgetBody>
        <el:row>
            <msg:page />
            <el:validatableResetForm name="allowanceTypeForm" callLoadingFunction="performPostActionWithEncodedId" controller="allowanceType" action="save">
