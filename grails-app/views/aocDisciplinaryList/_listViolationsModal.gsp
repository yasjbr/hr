...
--}%
            <btn:createButton onClick="createEmployeeViolation()"/>
...
<script type="text/javascript">
    ...
    function addEmployeeViolations() {
        ...
        $('#employeeViolations').hide();
        $('#mainForm').show();
    }
    function createEmployeeViolation() {
        var url = '${createLink(controller:'employeeViolation',action:'createNewEmployeeViolation', params:[employeeId: employeeId])}';
