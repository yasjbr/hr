...
/**
 * <h1>Purpose</h1>
 * To hold the notice category information
 * <h1>Usage</h1>
 * Used  as to represent the information of profile notice category, to categorize profile notices
 */
class ProfileNoticeCategory {
