...
/**
 * <h1>Purpose</h1>
 * To hold the Recruitment Cycle and the JobCategory many-to-many relation
 **/

class JoinedRecruitmentCycleJobCategory {
    ...
    static constraints = {
        ...
        jobCategory nullable: false,widget:"autocomplete"
