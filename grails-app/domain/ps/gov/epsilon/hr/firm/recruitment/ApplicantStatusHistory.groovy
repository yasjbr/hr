 ...
 * <h1>Usage</h1>
 * Used  as to represents the applicant status history
 *<h1>Example</h1>
 * NEW, INITIAL_REVIEW, SHORTLISTED,...etc.
 * **/
...
class ApplicantStatusHistory {
    ...
    EnumApplicantStatus applicantStatus

    ZonedDateTime fromDate
    ZonedDateTime toDate

    static belongsTo = [applicant:Applicant]
    ...
    static constraints = {
        applicantStatus nullable: false
