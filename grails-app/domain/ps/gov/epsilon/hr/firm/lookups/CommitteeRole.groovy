...
/**
 *<h1>Purpose</h1>
 * To hold the role of committee member
 * <h1>Usage</h1>
 * Used  as to represent role of committee member
 *<h1>Example</h1>
 * رئيس لجنة، عضو لجنة مقابلات، طبيب، .. الخ
 * **/
...
class CommitteeRole {
    ...
    /**
     * this code used to reprepsent the Iso or Zenar value of the lookup entry
     * **/
