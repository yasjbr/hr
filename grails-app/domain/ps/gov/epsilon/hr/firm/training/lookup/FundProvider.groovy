...
/**
 *<h1>Purpose</h1>
 * To hold the information about fund provider related to department or organization inside the firm
 * <h1>Usage</h1>
 * Used  as to represent the information of fund provider
 *<h1>Example</h1>
 * EU-Copps,UNDP...,etc.
 * **/
