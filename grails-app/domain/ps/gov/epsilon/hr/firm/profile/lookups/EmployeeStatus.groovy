...
/**
 *<h1>Purpose</h1>
 * To hold the Employee Status of the employee status category
 * <h1>Usage</h1>
 * Used  as to represents the Employee Status of the employee status category
 *<h1>Example</h1>
 * If the employee is on his work then the statuses of this category: in vacation, available, sick, ...etc.
 * **/
...
class EmployeeStatus {
    ...
    //flag to indicate if the employee is allowed to return to service after his (end of service) due to any reason
    // this flag is set when (status category = UNCOMMITTED)
    //هل يسمح له بالعودة للعمل؟
    Boolean allowReturnToService=false

    static belongsTo = [firm:Firm,employeeStatusCategory:EmployeeStatusCategory]
