...
/**
 *<h1>Purpose</h1>
 * To hold the Employee Status Category
 * <h1>Usage</h1>
 * Used  as to represents the Employee Status Category
 *<h1>Example</h1>
 * على راس عمله, خارج الخدمة
 * **/

class EmployeeStatusCategory {
    ...
    static  hasMany = [employeeStatuses:EmployeeStatus]
    ...
    static mapping = {
        employeeStatuses  cascade: 'save-update'
    }
}
