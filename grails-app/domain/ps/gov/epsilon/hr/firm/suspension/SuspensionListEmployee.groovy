...
class SuspensionListEmployee {
    ...
    static belongsTo = [suspensionRequest: SuspensionRequest, employee: Employee, suspensionList: SuspensionList]

    static hasMany = [suspensionListEmployeeNotes: SuspensionListEmployeeNote]
