...
// قوائم تمديد الاستيداع
class SuspensionExtensionList extends CorrespondenceList {
    def sharedService


    static hasMany = [suspensionExtensionListEmployees: SuspensionExtensionListEmployee]
    ...
    def beforeInsert() {
         ...
         */
        if (!this.code) {
            this.code = sharedService?.generateListCode("ps.gov.epsilon.hr.firm.suspension.SuspensionExtensionList", "SUSPENSION", 20)
        }
