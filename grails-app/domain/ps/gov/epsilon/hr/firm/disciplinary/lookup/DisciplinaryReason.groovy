...
/**
 *<h1>Purpose</h1>
 * To hold the penalty reasons
 * <h1>Usage</h1>
 * Used  as to represents all penalty reasons
 *<h1>Example</h1>
 * Absence,employee lateness from work...etc.
 * **/
//todo change the name to Violation
class DisciplinaryReason {
    ...
    static belongsTo = [firm:Firm, disciplinaryCategories:DisciplinaryCategory]

    static embedded = ['trackingInfo','descriptionInfo']

    static hasMany = [joinedDisciplinaryJudgmentReasons: JoinedDisciplinaryJudgmentReason]
