...
class JoinedEvaluationTemplateCategory {
    ...
    /**
     * One of them should be null and the other not
     * */
    ...
    static belongsTo = [evaluationTemplate:EvaluationTemplate]

    static embedded = ['trackingInfo']

    static constraints = {
        jobCategory nullable: true
        militaryRank nullable: true
