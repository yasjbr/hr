...
@Transactional
class AocEndOfServiceListService implements ICorrespondenceListService{
    ...
    PagedList searchWithRemotingValues(GrailsParameterMap params) {
        params.isEndOfServiceType = true
    ...
    CorrespondenceList save(GrailsParameterMap params) {
        params.serviceListType = EnumServiceListType.END_OF_SERVICE
